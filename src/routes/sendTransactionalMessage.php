<?php
$app->post('/api/Mandrill/sendTransactionalMessage', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'messageTo', 'messageFromEmail']);
    ...
    $query_str = $settings['api_url'] . "messages/send.json";
    $body = array();
