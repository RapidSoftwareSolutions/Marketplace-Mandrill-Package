<?php
$app->post('/api/Mandrill/addWebhook', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'webhookUrl']);
    ...
    $query_str = $settings['api_url'] . "webhooks/add.json";
    $body = array();
